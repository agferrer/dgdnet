...
<html>
<head>
<title>Modificacion de Personal Comisionado</title>
</head>
...
function Fechas(){
a1 = document.modifica_comisionado.fecha_oficio.value
a2 = document.modifica_comisionado.fecha_delegacion.value
if (a1> a2){
alert("La Fecha de Oficio no puede ser mas antigua que la del Ingreso a la Delegación. \nFavor de verificar los que esta capturando con respecto a las Fechas. Gracias.");
	 modifica_comisionado.Submit.disabled=true;
	 }
	 else{
	 modifica_comisionado.Submit.disabled=false;
	 }
}
function mueveReloj()
    {
     ...
     document.modifica_comisionado.reloj.value = horaImprimible
...
a.id_idioma, e.descripcion_idiomas, a.id_nivel_idioma, h.descripcion, a.sexo, a.observaciones, o.tipo, otra_carrera, delegacion_oe,funciones,
...
?>
<form name="modifica_comisionado" method="post" id="modifica_comisionado" action="save_modificacion_comisionado.php"  onSubmit="return validar(modifica_comisionado)">
<div align="center">
...
<legend align="center"><FONT COLOR='#000000' size="2" face="Verdana, Arial, Helvetica, sans-serif"><strong>MODIFICACIÓN DE PERSONAL COMISIONADO</strong></font></legend>
<? } if (($_SESSION["nivelw"]==9)){?>
<legend align="center"><FONT COLOR='#000000' size="2" face="Verdana, Arial, Helvetica, sans-serif"><strong>MODIFICACIÓN DE PERSONAL COMISIONADO DE LA DELEGACION <? echo $nom_delegacion;?><input type="hidden" name="delegacion" id="delegacion" value="<? echo $num_delegacion;?>"> </strong></font></legend>
<? }?>
<table width="1000px">
<tr>
...
<tr>
<td><FONT COLOR='#000000' size="2" face="Verdana, Arial, Helvetica, sans-serif">Físicamente en</FONT></td>
<td><input type="text" name="doe" id="doe" readonly="readonly"  value="<? echo $row['delegacion_oe'];?>" size="50" maxlength="15" onChange="conMayusculas(this)"></td>
</tr>
<?php if (($_SESSION["nivelw"]==4)||($_SESSION["nivelw"]==8)||($_SESSION["nivelw"]==42)||($_SESSION["nivelw"]==43)||($_SESSION["nivelw"]==24)||($_SESSION["nivelw"]==40)||($_SESSION["nivelw"]==35)||($_SESSION["nivelw"]==44)||($_SESSION["nivelw"]==46)){?>
<tr>
...
<?php
$res = mysql_query("select id_delegacion, nombre from delegaciones where tipo_delegg in(10,9,11) and aactivo='1'  order by nombre asc");
...
<option value="<? echo $row[13];?>" selected="selected"><? echo $row[14];?></option>
<?php
...
$sql3 = "select id_cargo, descripcion_cargo from tbl_cargo where activo_cargo='1' and categoria='COMISIONADO' and id_cargo!='$row[22]' order by descripcion_cargo asc";
...
<td colspan="6"><input type="text" name="fecha_delegacion" id="fecha_delegacion" value="<? echo $row[30];?>"  size="50" >
