...
left join delegaciones b on a.delegacion=b.id_delegacion left join tbl_cargo c on a.id_cargo=c.id_cargo where  a.activo like'0' and a.id_cargo!='23';");
...
<TD ALIGN='center'><a href="activa_comisionado.php?identificador=<? echo "$row[2]";?>" target="area_trabajo"><img src="extras/ico/page_edit.png" alt="Modificar trabajador"></a></td>

<? }
else if ($row[3]=='PERSONAL SRE'){?>
<TD ALIGN='left'><FONT size='1' face='Verdana, Arial, Helvetica, sans-serif'><a href="estatus_doctos.php?identificador=<? echo "$row[2]";?>" target="area_trabajo">Ver Doctos.</a></FONT></TD>
<TD ALIGN='center'><a href="activa_sre.php?identificador=<? echo "$row[2]";?>" target="area_trabajo"><img src="extras/ico/page_edit.png" alt="Modificar trabajador"></a></td>

<? }else if ($row[3]=='PERSONAL SRE_DGD'){?>
<TD ALIGN='left'><FONT size='1' face='Verdana, Arial, Helvetica, sans-serif'>Ver Doctos.</FONT></TD>
<TD ALIGN='center'><a href="activa_dgd.php?identificador=<? echo "$row[2]";?>" target="area_trabajo"><img src="extras/ico/page_edit.png" alt="Modificar trabajador"></a></td>
<? }?>
</TR>
