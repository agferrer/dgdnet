...
<legend align="center"><FONT COLOR='#000000' size="2" face="Verdana, Arial, Helvetica, sans-serif"><strong>PERSONAL SRE QUE FISICAMENTE ESTA EN UNA OFE</strong></font></legend>
...
<td rowspan="2"><font color="#000000" size="1" face="Verdana, Arial, Helvetica, sans-serif"><strong>Físicamente en</strong></font></td>
...
a.fecha_ingreso_delegacion, o.tipo, m.oems, l.nombre
from tbl_personal a
...
where tipo_personal='PERSONAL SRE' and lugar_fisico!=0  order by a.id_plaza asc ;");
...
<td align="center"><font color="#000000" size="1" face="Verdana, Arial, Helvetica, sans-serif"><? echo $row["oems"];?></font></td>
<td align="center"><font color="#000000" size="1" face="Verdana, Arial, Helvetica, sans-serif"><? echo $row["nombre"];?></font></td>
...
<tr>
<td align="center">
<button type="button" onClick="javascript:pdf('fisico_oe_pdf.php?nom_delegacion=<?php echo "$nom_delegacion"; ?>&delegacion=<?php echo "$delegacion"; ?>')"><img src="extras/ico/pdf.jpg" width="40" height="40" /></button>
</td></tr></table>
