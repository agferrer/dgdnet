...
<legend align="center"><FONT COLOR='#000000' size="2" face="Verdana, Arial, Helvetica, sans-serif"><strong>AGREGAR ASISTENCIA</strong></font></legend>
<table width="600px">
<tr>
...
$consulta=mysql_query("select a.id_trabajador, fecha_asis from tbl_asistencia a inner join tbl_personal b on b.id_personal=a.id_trabajador  where b.delegacion='$num_delegacion' and fecha_asis='$fecha_consulta';");
$filas=mysql_num_rows($consulta);

if($filas!=0){
?>
<form name="pasa_lista" method="post" id="pasa_lista" action="save_pasa_lista_dos.php"  onSubmit="return verifica()">
<div align="center">
...
<div align="center">
<fieldset style="width:750px">
<legend align="center"><FONT COLOR='#000000' size="2" face="Verdana, Arial, Helvetica, sans-serif"><strong>ASISTENCIA DEL DÍA <? echo $fecha_consulta;?> DE LA DELEGACIÓN <? echo $nom_delegacion;?></strong></font></legend>
...
where delegacion='$num_delegacion' and tipo_personal='PERSONAL COMISIONADO' and lugar_fisico='0' and a.activo=1 order by apellido_paterno asc;");	
$filas=mysql_num_rows($consulta);
$i=0;
 while ($i<$filas)
	  {
...
<table>
<tr>
<td><input type="submit" name="Submit" value="Guardar Asistencia"><input type="hidden" name="fecha_consulta" value="<? echo $fecha_consulta;?>"></td>
