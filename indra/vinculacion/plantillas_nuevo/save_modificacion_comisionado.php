...
fecha_ingreso_tabla_primaria, fecha_ingreso_tabla_secundaria, delegacion_oe, otra_carrera,funcionamiento, 
horario_trabajo_de, horario_trabajo_a, labora_de, labora_a, descanso1, descanso2)
...
fecha_insercion, concat(curdate(),' ',curtime()), delegacion_oe, otra_carrera, funciones, horario_trabajo_de, horario_trabajo_a, labora_de, labora_a, descanso1, descanso2
from tbl_personal where id_personal='$id_p';";
