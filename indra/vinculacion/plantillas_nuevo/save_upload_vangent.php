...
$inserta_upload_dos="insert into tbl_doctos(id_trabajador, archivo_cip, url_cip, archivo_pc, url_pc, fecha_upload)
values
('$id_p', '$cip_name', '$destino', '$pc_name', '$destino_dos', concat(curdate(),' ',curtime()));";
