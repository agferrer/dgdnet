...
if(!frm.nivel.value != ""){
 window.alert("Favor de seleccionar el Nivel / Perfil .");
  		 frm.nivel.focus();
       return false
  	}
if(!frm.cargo.value != ""){
...
?>
<form name="modifica_sre"  method="post" id="modifica_sre" action="save_modificacion_dgd.php"  onSubmit="return validar(modifica_sre)">
<div align="center">
...
<legend align="center"><FONT COLOR='#000000' size="2" face="Verdana, Arial, Helvetica, sans-serif"><strong>MODIFICACIÓN DE PERSONAL DGD</strong></font></legend>
<? } if (($_SESSION["nivelw"]==9)||($_SESSION["nivelw"]==45)){?>
<legend align="center"><FONT COLOR='#000000' size="2" face="Verdana, Arial, Helvetica, sans-serif"><strong>MODIFICACIÓN DE PERSONAL DGD DE LA DIRECCION <? echo $nom_delegacion;?>
