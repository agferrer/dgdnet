...
<legend align="center"><FONT COLOR='#000000' size="2" face="Verdana, Arial, Helvetica, sans-serif"><strong>OPERATIVO ZONA II</strong></font></legend>
...
where a.id_plaza='7'  order by l.nombre asc ;");
...
<tr>
<td align="center">
<button type="button" onClick="javascript:pdf('op_2_pdf.php')"><img src="../extras/ico/pdf.jpg" width="40" height="40" /></button>
</td></tr></table>
</form>
</body>
</html>
