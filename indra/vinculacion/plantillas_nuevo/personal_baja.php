...
$mysqli = Conectarse();
$link = Conectarse2();
$consulta=mysql_query("select concat(nombre_trabajador, ' ', apellido_paterno,' ', apellido_materno), b.nombre, id_personal, tipo_personal, c.descripcion_cargo, delegacion_oe, oems, fecha_ingreso_sre, fecha_ingreso_tabla_secundaria from tbl_historial_personal a
...
where nombre_trabajador like '%$nombre_personal%' and apellido_paterno like '%$apellido_p%' and apellido_materno like '%$apellido_m%' order by id_movimiento desc limit 1  ;");
...
<tr>
<td><FONT COLOR='#000000' size="1" face="Verdana, Arial, Helvetica, sans-serif"><strong>Fecha de Baja </strong></FONT></td>
<td><FONT COLOR='#000000' size="1" face="Verdana, Arial, Helvetica, sans-serif"><? echo $row[8];?></FONT></td>
</tr>
</table>
</fieldset>
</div>
...
where nombre_trabajador like '%$nombre_personal%' and apellido_paterno like '%$apellido_p%' and apellido_materno like '$apellido_m%'  order by id_movimiento desc;");
...
inner join evento_curso on id_evento=curso inner join tbl_historial_personal z on id_personal=id_trabajador where nombre_trabajador like '%$nombre_personal%' and apellido_paterno like '%$apellido_p%' and apellido_materno like '$apellido_m%';");
while ($row= mysql_fetch_array($consulta1)){
?>
<TR>
<td align="center"><FONT COLOR='#000000' size="1" face="Verdana, Arial, Helvetica, sans-serif"><? echo $row[0];?></FONT></td>
