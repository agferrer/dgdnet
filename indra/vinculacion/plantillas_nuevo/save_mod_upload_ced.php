...
$binario_contenido = addslashes(fread(fopen($binario_nombre_temporal, "rb"), filesize($binario_nombre_temporal))); 
          ...
          $cip_name = $_FILES["ced"]['name']; 
			...
			($tipo != "pdf") or die ("Sólo se admiten archivos en <b>.pdf</b>"); 
             $destino =  "cedulas_upload/MODIFICACION CEDULA_".$identificador."_".$cip_name; 
            (copy($_FILES['ced']['tmp_name'],$destino)) or die ("Error al subir el archivo ".$cip_name); 

        		
        
$actualizacion="Update tbl_doctos Set archivo_cip= '$cip_name', url_cip= '$destino' where id_trabajador='$identificador';";
