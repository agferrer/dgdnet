...
//$pdf->Cell(50,5,'',0,1,'L');
//$pdf->Cell(50,5,'',0,1,'L');
$pdf->Cell(50,4,'Oficina ' . $nom_delegacion . ', ' . $dia_num . ' de ' . $mes . ' de ' . $anio . '.',0,1,'L');
...
$pdf->MultiCell(190,4,'Certifico que la plantilla de personal y los datos en ella contenidos son correctos, completos y veraces al mes de '.$hoy.' del '.$anioant.', según reporte anexo. Los datos asentados están debidamente soportados con la documentación suficiente y pertinente que obra en los archivos de esta Oficina de Pasaportes, y que se encuentra disponible para cualquier aclaración posterior.',0,'J','J');
