...
$pdf->Cell(50,15,'',0,1,'L');
$pdf->Cell(50,5,'Asunto: Certificación de Plantillas de las Direcciones Generales de Delegaciones',0,1,'L');
$pdf->SetFont('Arial','B',11);
$pdf->Cell(50,5,'',0,1,'L');
$pdf->Cell(250,4,'Área ' . $nom_delegacion . ', México D.F. a ' . $dia_num . ' de ' . $mes . ' de ' . $anio . '.',0,1,'C');
//$pdf->Cell(250,4,'Área ' . $nom_delegacion . ', México D.F. a ' . '15' . ' de ' . 'Septiembre' . ' de ' . $anio . '.',0,1,'C');
$pdf->Cell(50,5,'',0,1,'L');
$pdf->Cell(50,5,'',0,1,'L');
...
//$pdf->MultiCell(190,4,'Certifico que la plantilla de personal y los datos en ella contenidos son correctos, completos y veraces al mes de '.$hoy.' del '.$anio.', según reporte anexo. Los datos asentados están debidamente soportados con la documentación suficiente y pertinente.',0,'J','J');
