...
$pdf->Cell(330,4,'AREA DE PASAPORTES',1,1,'C',1);
...
where a.id_area='1'  order by l.nombre asc ;");
...
$pdf->Cell(25,4,$row[17],1,0,'C');
$pdf->Cell(25,4,$row[8],1,0,'C');
$pdf->Cell(25,4,$row[18],1,0,'C');
$pdf->Cell(20,4,$row[16],1,0,'C');
