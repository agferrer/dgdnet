...
<legend align="center"><FONT COLOR='#000000' size="2" face="Verdana, Arial, Helvetica, sans-serif"><strong>COORDINADORES ADMINISTRATIVOS</strong></font></legend>
...
where a.id_cargo='5'  order by l.nombre asc ;");
...
<tr>
<td align="center">
<button type="button" onClick="javascript:pdf('sabana_coordadmin_pdf.php')"><img src="../extras/ico/pdf.jpg" width="40" height="40" /></button>
</td></tr></table>
</form>
</body>
</html>
