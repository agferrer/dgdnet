...
$pdf->Cell(330,4,'ENCARGADO DE INSUMOS',1,1,'C',1);
$pdf->SetFont('Arial','B',6);
$pdf->Cell(5,4,'No',1,0,'C',1);
$pdf->Cell(30,4,'Delegación',1,0,'C',1);
$pdf->Cell(45,4,'Nombre',1,0,'C',1);
$pdf->Cell(30,4,'Ubicación Física',1,0,'C',1);
$pdf->Cell(35,4,'Comisionado por',1,0,'C',1);
$pdf->Cell(30,4,'Número de Oficio',1,0,'C',1);
$pdf->Cell(25,4,'F. Oficio',1,0,'C',1);
$pdf->Cell(25,4,'F. ingreso',1,0,'C',1);
$pdf->Cell(30,4,'Área',1,0,'C',1);
$pdf->Cell(35,4,'Act. (Pasaportes)',1,0,'C',1);
$pdf->Cell(40,4,'Observaciones',1,0,'C',1);
$pdf->Ln();
$pdf->SetFont('Arial','',6);
...
where a.id_cargo='21'  order by l.nombre asc ;");
...
$pdf->SetFont('Arial','B',6);
$pdf->Cell(30,4,$row[20],1,0,'C');
$pdf->SetFont('Arial','',6);
$pdf->Cell(45,4,$row[3],1,0,'C');
$pdf->Cell(30,4,$row[2],1,0,'C');
$pdf->Cell(35,4,$row[7],1,0,'C');
$pdf->Cell(30,4,$row[9],1,0,'C');
$pdf->Cell(25,4,$row[10],1,0,'C');
$pdf->Cell(25,4,$row[18],1,0,'C');
$pdf->Cell(30,4,$row[15],1,0,'C');
$pdf->Cell(35,4,$row[16],1,0,'C');
$pdf->Cell(40,4,$row[19],1,0,'C');
$pdf->Ln();
	}
}
