...
<legend align="center"><FONT COLOR='#000000' size="2" face="Verdana, Arial, Helvetica, sans-serif"><strong>DELEGADOS</strong></font></legend>
...
where a.id_cargo='1'  order by l.nombre asc ;");
...
<tr>
<td align="center">
<button type="button" onClick="javascript:pdf('sabana_delegado_pdf.php')"><img src="extras/ico/pdf.jpg" width="40" height="40" /></button>
</td></tr></table>
</form>
</body>
</html>
