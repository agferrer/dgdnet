...
?>
<form name="modifica_sre"  method="post" id="modifica_sre" action="save_activa_sre.php"  >
<div align="center">
...
<?php
$sql2 = "select id_delegacion, nombre from delegaciones where tipo_delegg in(10,9) and aactivo='1' and id_delegacion!='$row[2]' order by nombre asc";
