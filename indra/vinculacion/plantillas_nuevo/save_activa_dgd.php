...
<?
if (($delegacion != $base_delegacion) || ($plaza != $base_plaza) || ($nivel != $base_nivel))
{
...
estructura= '$es', eventual= '$ev', honorarios= '$hon', id_nivel= '$nivel', id_plaza= '$plaza', fecha_ingreso_sre= '$fecha_sre',  fecha_ingreso_delegacion='$fecha_delegacion', id_estudios= '$nestudios', id_situacion= '$situacion', id_idioma= '$idioma', id_nivel_idioma='$nidiomas',
sexo= '$sexo', cant_mod= '$contador_mod', fecha_ult_modificacion= concat(curdate(),' ',curtime()), delegacion_oe='$lugar', otra_carrera='$otracarrera', id_rango='$sem', funciones='$funciones', activo='1'
