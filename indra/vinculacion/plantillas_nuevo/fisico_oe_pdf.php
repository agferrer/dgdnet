...
$pdf->Cell(331,4,'PERSONAL SRE UBICADO EN OFICINAS DE ENLACE ',1,1,'C',1);
...
$pdf->Cell(30,4,'Lugar Físico',1,0,'C',1);
$pdf->Cell(40,4,'Delegacion',1,0,'C',1);
...
$pdf->Cell(30,4,$row[20],1,0,'L');
$pdf->Cell(40,4,$row[21],1,0,'L');
