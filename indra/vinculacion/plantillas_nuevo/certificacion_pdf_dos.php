...
$pdf->Image('d:/AppServ/www/stm/imagenes/encabeza_oficio.png',10,10,180,70);
$pdf->Cell(50,15,'',0,1,'L');
$pdf->SetFont('Arial','B',9);

$pdf->Cell(300,4,'UNIDAD DE ADMINISTRACIÓN Y FINANZAS',0,1,'C');
$pdf->SetFont('Arial','B',9);

$pdf->Cell(300,4,'DIRECCIÓN GENERAL DE OFICINAS DE PASAPORTES',0,1,'C');
$pdf->SetFont('Arial','B',9);
$pdf->Cell(311.5,2,'COORDINACIÓN DE PASAPORTES',0,1,'C');
$pdf->SetFont('Arial','B',9);
...
$pdf->Cell(50,15,'',0,1,'L');
$pdf->Cell(50,5,'Asunto: Certificación de Plantillas del personal de Oficinas de Pasaportes',0,1,'L');
$pdf->SetFont('Arial','B',11);
$pdf->Cell(50,5,'',0,1,'L');
$pdf->Cell(250,4,'Área ' . $nom_delegacion . ', Ciudad de México a ' . $dia_num . ' de ' . $mes . ' de ' . $anio . '.',0,1,'C');
//$pdf->Cell(250,4,'Área ' . $nom_delegacion . ', Ciudad de México a ' . '4' . ' de ' . 'Octubre' . ' de ' . $anio . '.',0,1,'C');
$pdf->Cell(50,5,'',0,1,'L');
$pdf->Cell(50,5,'',0,1,'L');

$pdf->Cell(50,4,'Unidad de Administración y Finanzas ',0,1,'L');

$pdf->Cell(50,4,'Dirección General de Oficinas de Pasaportes',0,1,'L');
$pdf->Cell(50,3,'Coordinación de Pasaportes',0,1,'L');
...
$pdf->MultiCell(190,4,'Certifico que la plantilla de personal y los datos en ella contenidos son correctos, completos y veraces al mes de '.$hoy.' del '.$anioant.', según reporte anexo. Los datos asentados están debidamente soportados con la documentación suficiente y pertinente.',0,'J','J');
//$pdf->MultiCell(190,4,'Certifico que la plantilla de personal y los datos en ella contenidos son correctos, completos y veraces al mes de '.$hoy.' del 2018, según reporte anexo. Los datos asentados están debidamente soportados con la documentación suficiente y pertinente.',0,'J','J');
//$pdf->MultiCell(190,4,'Certifico que la plantilla de personal y los datos en ella contenidos son correctos, completos y veraces al mes de SEPTIEMBRE del 2019, según reporte anexo. Los datos asentados están debidamente soportados con la documentación suficiente y pertinente.',0,'J','J');
...
$pdf->Cell(100,4,'Funciones',1,0,'C',1);
$pdf->Ln();
...
descripcion_pasaportes, funciones from tbl_personal a left join tbl_cargo b on a.id_cargo=b.id_cargo left join tbl_plaza c on c.id_plaza=a.id_plaza
left join tbl_area d on d.id_area=a.id_area left join tbl_area_pasaportes e on a.id_area_pas=e.id_area_pas where a.delegacion='$delegacion' and  tipo_personal='PERSONAL SRE_DGD' and a.activo=1 order by a.orden asc;");/* estaba a.id_cargo en lugar de a.orden*/
...
$pdf->Cell(45,4,$row[2],1,0,'C');
$pdf->MultiCell(100,4,$row[5],1,1,'L');
$pdf->Ln();
	}
}
...
$pdf->Cell(50,3,'',0,1,'L');
$pdf->SetFont('Arial','',9);
$pdf->Cell(50,3,'_______________________________________________________',0,1,'L');
$pdf->SetTextColor(128);
$pdf->Cell(20,6,'',0,0,'L');
$pdf->Cell(50,6,$responsable,0,1,'L');
$pdf->Cell(22,6,'',0,0,'L');//mueve el cargo de derecha a izquierda
