...
sexo= '$sexo', cant_mod= '$contador_mod', fecha_ult_modificacion= concat(curdate(),' ',curtime()), delegacion_oe='$lugar', otra_carrera='$otracarrera', id_rango='$sem', funciones='$funciones'
