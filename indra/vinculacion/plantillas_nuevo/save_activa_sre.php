...
sexo= '$sexo', observaciones= '$obs', cant_mod= '$contador_mod', fecha_ult_modificacion= concat(curdate(),' ',curtime()), delegacion_oe='$lugar', lugar_fisico='$oe', otra_carrera='$otracarrera', id_rango='$sem', funciones='$funciiones', activo='1'
...
estructura= '$es', eventual= '$ev', honorarios= '$hon', id_nivel= '$nivel', id_plaza= '$plaza', fecha_ingreso_sre= '$fecha_sre', id_cargo= '$cargo', id_area= '$area', 
id_area_pas= '$area_pasaporte', fecha_ingreso_delegacion='$fecha_delegacion', id_estudios= '$nestudios', id_situacion= '$situacion', id_idioma= '$idioma', id_nivel_idioma='$nidiomas',
sexo= '$sexo', observaciones= '$obs', cant_mod= '$contador_mod', fecha_ult_modificacion= concat(curdate(),' ',curtime()), delegacion_oe='$lugar', lugar_fisico='$oe', otra_carrera='$otracarrera', id_rango='$sem', funciones='$funciones', activo='1'
where id_personal = '$id_p'";
