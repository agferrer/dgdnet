...
$sSQL="insert into tbl_movimientos_usuarios (tipo_movimientos, id_trabajador_afectado,  usuario, fecha) values ('MODIFICAR CEDULA', '0', '$user', concat(curdate(),' ',curtime())) ";

?>
<form name="upload" method="post" id="upload"  onSubmit="return validar(upload)" action="save_mod_upload_ced.php" enctype='multipart/form-data' >
<div align="center">
...
<table width="300px">
<tr>
<td><font color="#000000" size="1" face="Verdana, Arial, Helvetica, sans-serif">Mod. C.I.P.</font></td>
