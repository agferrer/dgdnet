...
if(!frm.consulta_fecha.value != ""){
 window.alert("Favor de Ingresar la Fecha Inicial.");
  		 frm.consulta_fecha.focus();
       return false
  	}				
if(!frm.consulta_fecha_fin.value != ""){
 window.alert("Favor de Ingresar la Fecha Final.");
  		 frm.consulta_fecha_final.focus();
       return false
  	}				
...
$hoy=strftime("%Y-%m-%d");
if (!isset($consulta_fecha_inicial))
	{
?>
<form name="consulta_fecha" id="consulta_fecha"  onSubmit="return validar(consulta_fecha)">
<div align="center">
<fieldset style="width:600px">
<legend align="center"><FONT COLOR='#000000' size="2" face="Verdana, Arial, Helvetica, sans-serif"><strong>CONSULTA DE ASISTENCIA POR PERIODO</strong></font></legend>
<table width="600px">
<tr>
<td align="right"><FONT COLOR='#000000' size="2" face="Verdana, Arial, Helvetica, sans-serif">Fecha Inicial</FONT></td>
<td align="left"><input type="text" name="consulta_fecha_inicial" value="" id="consulta_fecha_inicial" />
<button type="reset" id="f_trigger_b"> <img src="../../../imagenes/feb.gif" width="16" height="20" border="0"></button>
<script type="text/javascript">
    Calendar.setup({
        inputField     :    "consulta_fecha_inicial",      
        ifFormat       :    "%Y-%m-%d",      
        showsTime      :    true,            
        button         :    "f_trigger_b",   
        singleClick    :    false,           
	  ...
	  <td align="right"><FONT COLOR='#000000' size="2" face="Verdana, Arial, Helvetica, sans-serif">Fecha Final</FONT></td>
<td align="left"><input type="text" name="consulta_fecha_final" value="" id="consulta_fecha_final" />
<button type="reset" id="f_trigger_b_b"> <img src="../../../imagenes/feb.gif" width="16" height="20" border="0"></button>
<script type="text/javascript">
    Calendar.setup({
        inputField     :    "consulta_fecha_final",      
        ifFormat       :    "%Y-%m-%d",      
        showsTime      :    true,            
        button         :    "f_trigger_b_b",   
        singleClick    :    false,           
        step           :    1                
    });
	  </script> </td></tr>
...
fecha_asis between '$consulta_fecha_inicial' and '$consulta_fecha_final' and lugar_fisico='0' and a.activo='1' order by apellido_paterno asc;");
...
<tr>
<td align="center">
<button type="button" onClick="javascript:pdf('consulta_mensual_pdf.php?num_delegacion=<?php echo "$num_delegacion"; ?>&consulta_fecha_inicial=<?php echo "$consulta_fecha_inicial"; ?>&consulta_fecha_final=<?php echo "$consulta_fecha_final"; ?>')"><img src="extras/ico/pdf.jpg" width="40" height="40" /></button>
</td></tr></table>
