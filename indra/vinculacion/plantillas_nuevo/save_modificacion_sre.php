...
?>
<form name="save_modificacion_sre" method="post" id="save_modificacion_sre">
<div align="center">
<fieldset style="width:1000px">
<?
if (($delegacion != $base_delegacion) || ($cargo != $base_cargo) || ($plaza != $base_plaza) || ($nivel != $base_nivel) || ($area != $base_area) || ($area_pasaporte != $base_area_pasaporte))
{
...
fecha_ingreso_tabla_primaria, fecha_ingreso_tabla_secundaria, delegacion_oe, otra_carrera, funcionamiento, horario_trabajo_de, horario_trabajo_a, 
labora_de, labora_a, descanso1, descanso2)
...
fecha_insercion, concat(curdate(),' ',curtime()), delegacion_oe, otra_carrera, funciones, horario_trabajo_de, horario_trabajo_a, 
labora_de, labora_a, descanso1, descanso2 from tbl_personal where id_personal='$id_p';";
...
$actualizacion="Update tbl_personal Set delegacion= '$delegacion', rfc='$rfc', nombre_trabajador= '$nombre_personal', apellido_paterno= '$apellidop_p', apellido_materno= '$apellidom_p',
estructura= '$es', eventual= '$ev', honorarios= '$hon', id_nivel= '$nivel', id_plaza= '$plaza', fecha_ingreso_sre= '$fecha_sre', id_cargo= '$cargo', id_area= '$area', 
id_area_pas= '$area_pasaporte', fecha_ingreso_delegacion='$fecha_delegacion', id_estudios= '$nestudios', id_situacion= '$situacion', id_idioma= '$idioma', id_nivel_idioma='$nidiomas',
sexo= '$sexo', observaciones= '$obs', cant_mod= '$contador_mod', fecha_ult_modificacion= concat(curdate(),' ',curtime()), delegacion_oe='$lugar', lugar_fisico='$oe', otra_carrera='$otracarrera', id_rango='$sem', funciones='$funciiones'
,horario_trabajo_de='$hor_ent', horario_trabajo_a='$hor_sal', labora_de='$sem_ent', labora_a='$sem_sal', descanso1='$desc_ent', descanso2='$desc_sal' 
...
estructura= '$es', eventual= '$ev', honorarios= '$hon', id_nivel= '$nivel', id_plaza= '$plaza', fecha_ingreso_sre= '$fecha_sre', id_cargo= '$cargo', id_area= '$area', 
id_area_pas= '$area_pasaporte', fecha_ingreso_delegacion='$fecha_delegacion', id_estudios= '$nestudios', id_situacion= '$situacion', id_idioma= '$idioma', id_nivel_idioma='$nidiomas',
sexo= '$sexo', observaciones= '$obs', cant_mod= '$contador_mod', fecha_ult_modificacion= concat(curdate(),' ',curtime()), delegacion_oe='$lugar', lugar_fisico='$oe', otra_carrera='$otracarrera', id_rango='$sem', funciones='$funciones'
,horario_trabajo_de='$hor_ent', horario_trabajo_a='$hor_sal', labora_de='$sem_ent', labora_a='$sem_sal', descanso1='$desc_ent', descanso2='$desc_sal'
where id_personal = '$id_p'";
