...
<html>
<head>
<title>Modificar de Personal SRE</title>
</head>
...
function Fechas(){
a1 = document.modifica_sre.fecha_sre.value
a2 = document.modifica_sre.fecha_delegacion.value
if (a1> a2){
alert("La Fecha de ingreso a la Delegación no puede ser mas antigua que la del Ingreso a la Secretaría. \nFavor de verificar lo que esta capturando con respecto a las Fechas de Ingreso. Gracias.");
	 modifica_sre.Submit.disabled=true;
	 }
	 else{
	 modifica_sre.Submit.disabled=false;
	 }
}
function mueveReloj()
    {
     ...
     document.modifica_sre.reloj.value = horaImprimible
...
a.id_idioma, e.descripcion_idiomas, a.id_nivel_idioma, h.descripcion, a.sexo, a.observaciones, o.tipo, otra_carrera,funciones,
horario_trabajo_de, horario_trabajo_a, labora_de, labora_a, descanso1, descanso2
from tbl_personal a
...
?>
<form name="modifica_sre"  method="post" id="modifica_sre" action="save_modificacion_sre.php"  onSubmit="return validar(modifica_sre)">
<div align="center">
...
<legend align="center"><FONT COLOR='#000000' size="2" face="Verdana, Arial, Helvetica, sans-serif"><strong>MODIFICACIÓN DE PERSONAL SRE</strong></font></legend>
<? } if (($_SESSION["nivelw"]==9)){?>
<legend align="center"><FONT COLOR='#000000' size="2" face="Verdana, Arial, Helvetica, sans-serif"><strong>MODIFICACIÓN DE PERSONAL SRE DE LA DELEGACI&Oacute;N <? echo $nom_delegacion;?>
...
<?php
$sql2 = "select id_delegacion, nombre from delegaciones where tipo_delegg in(10,9,11) and aactivo='1' and id_delegacion!='$row[2]' order by nombre asc";
...
<td><select name="rango_sem" id "rango_sem"  style="width:315px">
...
&nbsp;&nbsp;
<select id="sem" name="sem" style='width:250px' ><option value="<? echo $row[28];?>"><? echo $row[29];?></option></option></select></td>
</tr>
...
$sql3 = "select id_cargo, descripcion_cargo from tbl_cargo where activo_cargo='1' and categoria='SRE' and id_cargo!='$row[22]' order by descripcion_cargo asc";
...
&nbsp;
<select id="area_pasaporte" name="area_pasaporte" style="width:250px"><option value="<? echo $row[26];?>" selected="selected" ><? echo $row[27];?></option></select></td>
</tr>
<tr>
...
&nbsp;
<select id="situacion" name="situacion" style="width:250px">
  <option value="<? echo $row[34];?>" selected="selected" ><? echo $row[35];?></option>
</select></td>
</tr>
<tr >
<td><FONT COLOR='#000000' size="2" face="Verdana, Arial, Helvetica, sans-serif">Especifíque Carrera</FONT></td>
<td><input type="text" name="otracarrera" id="otracarrera" size="30" value="<? echo $row[43];?> " maxlength="50" onChange="conMayusculas(this)"></td></tr>
...
<td colspan="6"><input type="text" name="fecha_delegacion" value="<? echo $row[30];?>" id="fecha_delegacion"  size="50">
...
&nbsp;&nbsp;
<FONT COLOR='#000000' size="2" face="Verdana, Arial, Helvetica, sans-serif" id="loe">OE</FONT>
&nbsp;
<?php if (($_SESSION["nivelw"]==4)||($_SESSION["nivelw"]==8)||($_SESSION["nivelw"]==42)||($_SESSION["nivelw"]==43)||($_SESSION["nivelw"]==24)||($_SESSION["nivelw"]==40)||($_SESSION["nivelw"]==35)||($_SESSION["nivelw"]==44)||($_SESSION["nivelw"]==46)){?>
<select id="oe" name="oe" style="width:250px"><option  selected="selected" value="<? echo $row[4];?>"><? echo $row[5];?></option></select><? }?>
<?php if ($_SESSION["nivelw"]==9){?>
<select name="oe" id "oe" style="width:250px">
<option selected="selected" value="<? echo $row[4];?>"><? echo $row[5];?></option>
<option value="">Seleccionar</option>
<?php
...
<?php if (($_SESSION["nivelw"]==4)||($_SESSION["nivelw"]==8)||($_SESSION["nivelw"]==42)||($_SESSION["nivelw"]==43)||($_SESSION["nivelw"]==24)||($_SESSION["nivelw"]==40)||($_SESSION["nivelw"]==44)||($_SESSION["nivelw"]==46)){?>
<tr>
<td><FONT COLOR='#000000' size="2" face="Verdana, Arial, Helvetica, sans-serif">Funciones</FONT></td>
<td><textarea name="funciones" id="funciones" rows="10" cols="100" onChange="conMayusculas(this)"><? echo $row[44];?></textarea></td>
</tr>
<? }?>
...
<select name='hor_ent'>
<option value="<? echo $row["horario_trabajo_de"];?>" selected><? echo $row["horario_trabajo_de"];?></option>
<option value="">Seleccionar</option>
...
<select name='hor_sal'>
<option value="<? echo $row["horario_trabajo_a"];?>" selected><? echo $row["horario_trabajo_a"];?></option>
<option value="">Seleccionar</option>
...
<td><FONT COLOR='#000000' size="2" face="Verdana, Arial, Helvetica, sans-serif">De &nbsp; 
<select name='sem_ent'>
<option value="<? echo $row["labora_de"];?>" selected><? echo $row["labora_de"];?></option>
<option value="">Seleccionar</option>
...
<select name='sem_sal'>
<option value="<? echo $row["labora_a"];?>" selected><? echo $row["labora_a"];?></option>
<option value="">Seleccionar</option>
<option value='Domingo'>Domingo</option>
<option value='Lunes'>Lunes</option>
<option value='Martes'>Martes</option>
...
<option value="<? echo $row["descanso1"];?>" selected><? echo $row["descanso1"];?></option>
<option value="">Seleccionar</option>
<option value='Domingo'>Domingo</option>
<option value='Lunes'>Lunes</option>
<option value='Martes'>Martes</option>
...
<option value="<? echo $row["descanso2"];?>" selected><? echo $row["descanso2"];?></option>
<option value="">Seleccionar</option>
<option value='Domingo'>Domingo</option>
<option value='Lunes'>Lunes</option>
<option value='Martes'>Martes</option>
...
<tr>
<td colspan="2" align="center"><input type="submit" name="Submit"  value="Actualizar Datos">
