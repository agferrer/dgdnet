...
$pdf->Cell(330,4,'AREA DE PASAPORTES (DICTAMINACIÓN DE EXPEDIENTES EN DELEGACIÓN)',1,1,'C',1);
$pdf->SetFont('Arial','B',6);
$pdf->Cell(5,4,'No',1,0,'C',1);
$pdf->Cell(30,4,'Delegación',1,0,'C',1);
$pdf->Cell(50,4,'Nombre',1,0,'C',1);
$pdf->Cell(35,4,'Cargo',1,0,'C',1);
$pdf->Cell(30,4,'Plaza',1,0,'C',1);
...
where a.id_area='1' and a.id_area_pas='12'  order by l.nombre asc ;");
...
$pdf->Cell(35,4,$row[13],1,0,'C');
$pdf->Cell(30,4,$row[12],1,0,'C');
...
$pdf->Cell(30,4,$row[17],1,0,'C');
$pdf->Cell(25,4,$row[8],1,0,'C');
$pdf->Cell(25,4,$row[18],1,0,'C');
$pdf->Cell(39,4,$row[19],1,0,'C');
$pdf->Ln();
	}
}
